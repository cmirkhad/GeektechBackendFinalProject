...
urlpatterns = [
                  ...
                  path('api/v1/news/<int:pk>', main_views.NewsDetailAPIView.as_view()),
                  path('api/v1/laws/', main_views.LawListAPIView.as_view()),
                  path('api/v1/laws/<int:pk>', main_views.LawDetailAPIView.as_view()),
                  path('api/v1/publications/', main_views.PublicationListAPIView.as_view()),
                  path('api/v1/publications/<int:pk>', main_views.PublicationDetailAPIView.as_view()),
